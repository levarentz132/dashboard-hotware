            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-gray-400 mt-1">{camera.id} • {camera.typeId || 'Camera'}</div>
                </div>
              </div>
              
              <div className="flex flex-col items-end space-y-2">
                {getStatusIcon(camera.status)}
                <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getStatusColor(camera.status || 'unknown')}`}>
