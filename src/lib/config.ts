...
function getServerSideConfig(): Record<string, string> {
  ...
  if (!configPath || !fs.existsSync(configPath)) {
    const envConfig = {
      ...
      NEXT_PUBLIC_LICENSE_USERNAME: process.env.NEXT_PUBLIC_LICENSE_USERNAME || '',
      NEXT_PUBLIC_LICENSE_PASSWORD: process.env.NEXT_PUBLIC_LICENSE_PASSWORD || '',
...
export function getDynamicConfig(request?: Request | NextRequest) {
  ...
  if (request) {
    ...
    if (hSystemId) {
      headersConfig = {
        ...
        NEXT_PUBLIC_LICENSE_USERNAME: getH('x-electron-license-username'),
        NEXT_PUBLIC_LICENSE_PASSWORD: getH('x-electron-license-password'),
  ...
  if (headersConfig) {
    return {
      ...
      NEXT_PUBLIC_LICENSE_USERNAME: headersConfig.NEXT_PUBLIC_LICENSE_USERNAME || diskConfig.NEXT_PUBLIC_LICENSE_USERNAME || '',
      NEXT_PUBLIC_LICENSE_PASSWORD: headersConfig.NEXT_PUBLIC_LICENSE_PASSWORD || diskConfig.NEXT_PUBLIC_LICENSE_PASSWORD || '',
